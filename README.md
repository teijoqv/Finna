...
Lisää kirjastoyksiköitä, osastoja, aineistolajeja ja sijainteja. Yksiköiden, osastojen ja sijaintien täytyy olla samassa muodossa kuin kirjastojärjestelmässä. Aineistolajien täytyy olla samassa muodossa kuin Finnassa teostiedoissa on (hakurajaimessa näkyy sellaisiakin termejä, joita teoksilla itsellään ei ole, esim. aineistolajia videopeli ei ole niillä, vaan sen sijaan PlayStation jne.). Annna kirjastoyksiköille lisäksi sääntöryhmän nimi. Sen kannattaa perustua jotenkin kirjaston nimeen, jottei eri yksiköille vahingossa käytettäisi samaa, mutta muuten sillä ei ole väliä.
